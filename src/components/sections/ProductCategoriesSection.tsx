...
function CategoryTile({ cat }: { cat: Cat }) {
  ...
  return (
    <Link
      ...
      className="group flex flex-col bg-white rounded-2xl border border-slate-100 hover:border-brand/40 hover:shadow-[0_10px_30px_rgb(0,0,0,0.06)] transition-all overflow-hidden"
    >
